...
import 'package:galsa_trial2/core/theming/font_weight_helper.dart';
...
class TextStyles {
  ...
  static TextStyle font10BlackRegular = const TextStyle(
      fontSize: 10,
      color: Colors.black,
      fontWeight: FontWeightHelper.regular
  );
  ...
  static TextStyle font25BlackMedium = const TextStyle(
      fontSize: 25,
      color: Colors.black,
      fontWeight: FontWeightHelper.medium
  );
  static TextStyle font22GreenBold = const TextStyle(
      fontSize: 22,
      color: Colors.green,
      fontWeight: FontWeightHelper.bold
  );
  ...
  static TextStyle font14Black54Regular = const TextStyle(
      fontSize: 14,
